//! Transformation depth-based `cost` function definition.
...
/// Definition of the tansformation depth-based `cost` function.
pub struct TransformDepthCost;

impl SingletonFunction for TransformDepthCost {
    const INSTANCE: Self = TransformDepthCost {};
}

impl Function for TransformDepthCost {
...
impl DefinedFunction for TransformDepthCost {
...
impl InlineFunction for TransformDepthCost {
