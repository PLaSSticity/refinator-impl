...
fn sub_bit(a: bool, b: bool, carry: bool, carry_result: &mut i8) -> bool {
    let mut b2: i8 = 0;
    let mut b1: i8 = 0;
    let result = half_sub(half_sub(a, b, &mut b1), carry, &mut b2);
    let b1 = bit_to_bool(b1);
    let b2 = bit_to_bool(b2);
    *carry_result = bool_to_bit(or(b1, b2));
    result
}
...
fn half_sub(a: bool, b: bool, carry_result: &mut i8) -> bool {
    *carry_result = bool_to_bit(and(not(a), b));
    xor(a, b)
}
fn print_add_bit(a: bool, b: bool, carry: bool) {
    ...
    let mut res_carry: i8 = 0;
    println!("result :");
    println!("  bit  : {}", bll(add_bit(a, b, carry, &mut res_carry)));
    println!("  carry: {}", bll(bit_to_bool(res_carry)));
}
...
fn add_bit(a: bool, b: bool, carry: bool, carry_result: &mut i8) -> bool {
    *carry_result = bool_to_bit(and(or(a, b), or(and(a, b), carry)));
    xor(xor(a, b), carry)
}
