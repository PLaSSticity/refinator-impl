...
#define tsp_env_name_prim(NAME, FN) tisp_env_add(st, #NAME, mk_prim(TSP_PRIM, global_prim_val, #NAME))
#define tsp_env_prim(NAME)          tsp_env_name_prim(NAME, NAME)
#define tsp_env_name_form(NAME, FN) tisp_env_add(st, #NAME, mk_prim(TSP_FORM, global_prim_val, #NAME))
...
Val prim_func(Tsp t, Rec r, Val v) { Val tmp; return tmp; }
